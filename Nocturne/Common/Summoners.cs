...
namespace Nocturne.Common
{
    internal class Summoners
    {
        ...
        public static void Initialize()
        {
            ...
            {
                PlayerMenu.Config.AddItem(new MenuItem("Spells.Smite", "Use Smite to Enemy!").SetValue(true));
            }

            SetIgniteSlot();
            if (IgniteSlot != SpellSlot.Unknown)
            {
                PlayerMenu.Config.AddItem(new MenuItem("Spells.Ignite", "Use Ignite!").SetValue(true));
            }
        ...
        {
            var range = 700f;
            var use = PlayerMenu.Config.Item("Spells.Smite").GetValue<bool>();
        ...
        {
            var range = 550f;
            var use = PlayerMenu.Config.Item("Spells.Ignite").GetValue<bool>();
