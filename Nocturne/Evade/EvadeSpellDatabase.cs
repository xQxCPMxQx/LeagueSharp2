...
namespace Nocturne.Evade
{
    internal class EvadeSpellDatabase
    {
        ...
        static EvadeSpellDatabase()
        {
            ...
            {
                spell = new DashData("MasterYi Q", SpellSlot.Q, 650, false, 100, 2200, 3);
                spell.ValidTargets = new[] { SpellValidTargets.EnemyChampions, SpellValidTargets.EnemyMinions };
                Spells.Add(spell);
            }
            ...
            if (ObjectManager.Player.ChampionName == "Nocturne")
            {
                spell = new DashData("Nocturne W1", SpellSlot.W, 600, false, 100, 1621, 3);
                spell.CheckSpellName = "NocturneSlide";
                Spells.Add(spell);
            }

            if (ObjectManager.Player.ChampionName == "Nocturne")
            {
                spell = new DashData("Nocturne RW", SpellSlot.R, 600, false, 100, 1621, 3);
                spell.CheckSpellName = "NocturneSlideM";
                Spells.Add(spell);
            }
