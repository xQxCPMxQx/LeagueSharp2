...
namespace Syndra
{
    internal class Program
    {
        ...
        {
			var qTarget = GetEnemy(Q.Range + (isHarass ? Q.Width / 3 : Q.Width), TargetSelector.DamageType.Magical);
            var wTarget = GetEnemy(W.Range + W.Width, TargetSelector.DamageType.Magical);
            var rTarget = GetEnemy(R.Range, TargetSelector.DamageType.Magical);
            var qeTarget = GetEnemy(EQ.Range, TargetSelector.DamageType.Magical);
