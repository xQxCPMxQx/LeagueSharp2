...
namespace JaxQx
{
    ...
    internal class AssassinManager
    {
        ...
        public void Load()
        {
            ...
            this.Config.AddItem(new MenuItem("TS", "Active Target Selector:").SetValue(new StringList(new[] { "Jax Target Selector", "L# Target Selector" }))).SetFontStyle(FontStyle.Regular, SharpDX.Color.GreenYellow)
        ...
        {
            if (this.Selector != TargetSelect.Jax)
            {
                return;
            }
