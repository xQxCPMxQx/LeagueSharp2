...
namespace JaxQx
{
    internal class Program
    {
        ...
        public static string[] TestSpells = { "RelicSmallLantern", "RelicLantern", "SightWard", "wrigglelantern", "ItemGhostWard", "VisionWard", "BantamTrap", "JackInTheBox", "CaitlynYordleTrap", "Bushwhack" };
        public static Map map;

        private static SpellSlot IgniteSlot;
        private static SpellSlot SmiteSlot;
        private static float wardRange = 600f;
        ...
        private static void JungleFarm()
        {
            ...
            if (Q.IsReady() && useQ && Player.Distance(mobs[0]) > Orbwalking.GetRealAutoAttackRange(ObjectManager.Player))
                Q.CastOnUnit(mobs[0]);
