...
namespace Shen.Modes
{
    internal class ModeUlti
    {
        ...
        public static void Initialize(LeagueSharp.Common.Menu menuConfig)
        {
            ...
            LocalMenu.AddItem(new MenuItem("SpellR.ConfirmKey", "Ulti Confirm Key!").SetValue(new KeyBind("U".ToCharArray()[0], KeyBindType.Press)).SetFontStyle(FontStyle.Regular, SharpDX.Color.IndianRed));
