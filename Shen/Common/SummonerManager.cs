...
namespace Shen.Common
{
    internal class SummonerManager
    {
        ...
        public static void Initialize()
        {
            ...
            {
                Modes.MenuConfig.LocalMenu.AddItem(new MenuItem("Spells.Smite", "Use Smite to Enemy!").SetValue(true));
            }

            SetIgniteSlot();
            if (IgniteSlot != SpellSlot.Unknown)
            {
                Modes.MenuConfig.LocalMenu.AddItem(new MenuItem("Spells.Ignite", "Use Ignite!").SetValue(true));
            }
        ...
        {
            var t = TargetSelector.GetTarget(Shen.Champion.PlayerSpells.Q.Range, TargetSelector.DamageType.Magical);
        ...
        {
            var range = 700f;
            var use = Modes.MenuConfig.LocalMenu.Item("Spells.Smite").GetValue<bool>();
        ...
        {
            var range = 550f;
            var use = Modes.MenuConfig.LocalMenu.Item("Spells.Ignite").GetValue<bool>();
