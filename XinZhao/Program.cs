...
namespace XinZhao
{
    internal class Program
    {
        ...
        private static void CreateChampionMenu()
        {
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("ComboActive", "Combo!", false, TextFontStyle.Bold, Color.Yellow).SetValue(new KeyBind(Config.Item("Orbwalk").GetValue<KeyBind>().Key, KeyBindType.Press)));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("LaneClearActive", "LaneClear!", false, TextFontStyle.Bold, Color.Yellow).SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
